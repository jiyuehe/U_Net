...
# training parameters
parameters['batch_size'] = 64 # number of training samples (electrograms-activation_maps pairs of 1 simulation on 1 geometry) processed together in one pass during training
...
if train_predict_flag == 0:
   ...
   if testing_data_flag == 0: # 0: simulation data; 1: clinical data
      ...
      file_names_test = [
         '99_2-LaFAM_cartofinder_data_clinical_data.npz',
         '100_1-LA FAM1_clinical_data.npz',
         '101_1-lagood_clinical_data.npz',
      ]
